...
# Database engine
engine = create_engine('mysql+mysqlconnector://root:elgert1234@localhost:3306/news_db', echo=True)
...
class ArticleTopChannel(Base):
    __tablename__ = 'articles_top_channel'
